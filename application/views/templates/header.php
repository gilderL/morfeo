<div id="Header">
    ...
    <div id="Login">
     ...
     <div id="In" class="button"><input class="buttom" type="submit" value="Login"/></div>
      </form>
      <div id="Register" class="button"><button class="buttom" type="button" onclick="">Register</button></div>
    </div>
</div>